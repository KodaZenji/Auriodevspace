    ...
    <div className="min-h-screen bg-[#080808] text-zinc-200" style={{ fontFamily: "'DM Mono', monospace" }}>
      ...
      <header className="border-b border-zinc-900 px-6 py-4 flex items-center justify-between sticky top-0 bg-[#080808]/95 backdrop-blur z-40">
        ...
        <div className="flex items-center gap-4">
          <Link href="/japa-dev/canada" className="text-xs text-zinc-500 hover:text-red-400 transition-colors">
            🍁 Canada Guide
          </Link>
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mb-10">
          ...
          <p className="text-zinc-400 text-sm leading-relaxed max-w-2xl">
            ...
            with honest assessments for both <span className="text-zinc-200">ND holders</span> and <span className="text-zinc-200">BSc holders</span>.
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
          ...
          <div className="bg-zinc-900 border border-green-900 rounded-xl p-4">
                ...
                {VISA_ROUTES.map((route) => (
                  <tr key={route.id} className="border-b border-zinc-900 hover:bg-zinc-900/50 transition-colors">
                    <td className="py-3 pr-4">
                      <a href={`#${route.id}`} className="text-zinc-200 hover:text-green-400 transition-colors">{route.name}</a>
                    </td>
                    <td className="py-3 pr-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="bg-zinc-950 border border-zinc-800 rounded-lg p-3">
                      <p className="text-[10px] uppercase tracking-widest text-zinc-500 mb-1">ILR?</p>
        ...
        {/* Cross-link to Canada */}
        <div className="bg-zinc-900 border border-red-900/50 rounded-2xl p-6 mb-8">
          <p className="text-xs uppercase tracking-widest text-zinc-500 mb-2">Also on JapaDev</p>
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              <p className="text-sm font-bold text-zinc-100" style={{ fontFamily: "Syne, sans-serif" }}>
                🍁 Canada Visa Guide
              </p>
        ...
        <div className="bg-zinc-900 border border-green-900 rounded-2xl p-6 text-center">
          <p className="text-sm font-bold text-zinc-100 mb-2" style={{ fontFamily: "Syne, sans-serif" }}>Ready to start applying?</p>
          <p className="text-xs text-zinc-400 mb-4">Track applications, access curated job boards, and use ready-made outreach scripts.</p>
