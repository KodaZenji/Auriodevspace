    ...
    <div className="min-h-screen bg-white dark:bg-[#080808] text-zinc-800 dark:text-zinc-200" style={{ fontFamily: "'DM Mono', monospace" }}>
      ...
      <header className="border-b border-zinc-200 dark:border-zinc-900 px-6 py-4 flex items-center justify-between sticky top-0 bg-white/95 dark:bg-[#080808]/95 backdrop-blur z-40">
        ...
        <div className="flex items-center gap-4">
          <Link href="/japa-dev/visa" className="text-xs text-zinc-600 dark:text-zinc-500 hover:text-green-400 transition-colors">
            🇬🇧 UK Guide
          </Link>
          <span className="text-zinc-500 dark:text-zinc-600 text-xs hidden sm:inline">Canada Visa Guide · 2026</span>
          <ThemeToggle />
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mb-10">
          ...
          <p className="text-zinc-600 dark:text-zinc-400 text-sm leading-relaxed max-w-2xl">
            ...
            <span className="text-zinc-800 dark:text-zinc-200">ND holders</span> and <span className="text-zinc-800 dark:text-zinc-200">BSc holders</span>.
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
          <div className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-700 rounded-xl p-4">
            ...
            <p className="text-xs text-zinc-600 dark:text-zinc-400 leading-relaxed">
              ...
              Your best route is <span className="text-zinc-800 dark:text-zinc-200">PNP via a Canadian job offer</span>, or
              Study Permit → PGWP → CEC. Express Entry direct is hard without boosters.
            </p>
          </div>
          <div className="bg-zinc-100 dark:bg-zinc-900 border border-red-900 rounded-xl p-4">
            ...
            <p className="text-xs text-zinc-600 dark:text-zinc-400 leading-relaxed">
              ...
              <span className="text-zinc-800 dark:text-zinc-200"> Canada gets meaningfully easier with a degree.</span>
            </p>
          </div>
        </div>

        <div className="mb-12 bg-zinc-100 dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-800 rounded-xl p-5">
          <h2 className="text-xs uppercase tracking-widest text-zinc-600 dark:text-zinc-500 mb-4">Canada vs UK — At a Glance</h2>
          <div className="overflow-x-auto">
            <table className="w-full text-xs border-collapse">
              <thead>
                <tr className="border-b border-zinc-300 dark:border-zinc-800">
                  <th className="text-left py-2 pr-4 text-zinc-600 dark:text-zinc-500 font-normal">Factor</th>
                  <th className="text-left py-2 pr-4 text-zinc-600 dark:text-zinc-400 font-normal">🇬🇧 UK</th>
              ...
              <tbody className="space-y-1">
                {[
                  ...
                  <tr key={i} className="border-b border-zinc-200 dark:border-zinc-900">
                    <td className="py-2 pr-4 text-zinc-600 dark:text-zinc-500">{factor}</td>
                    <td className="py-2 pr-4 text-zinc-700 dark:text-zinc-300">{uk}</td>
                    <td className="py-2 text-zinc-700 dark:text-zinc-300">{ca}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className="mb-12">
          <h2 className="text-xs uppercase tracking-widest text-zinc-600 dark:text-zinc-500 mb-4">Quick Route Comparison</h2>
          <div className="overflow-x-auto">
            <table className="w-full text-xs border-collapse">
              <thead>
                <tr className="border-b border-zinc-300 dark:border-zinc-800">
                  <th className="text-left py-3 pr-4 text-zinc-600 dark:text-zinc-400 font-normal">Route</th>
                  <th className="text-left py-3 pr-4 text-zinc-600 dark:text-zinc-400 font-normal">Leads to PR?</th>
                  ...
                  <th className="text-left py-3 text-zinc-600 dark:text-zinc-400 font-normal">Entry route?</th>
                </tr>
              </thead>
              <tbody>
                {CANADA_ROUTES.map((route) => (
                  <tr key={route.id} className="border-b border-zinc-200 dark:border-zinc-900 hover:bg-zinc-100 dark:hover:bg-zinc-900/50 transition-colors">
                    <td className="py-3 pr-4">
                      <a href={`#${route.id}`} className="text-zinc-800 dark:text-zinc-200 hover:text-red-400 transition-colors">{route.name}</a>
                    </td>
                    <td className="py-3 pr-4">
                      {route.leadsToPR ? <span className="text-green-400">Yes</span> : <span className="text-zinc-600 dark:text-zinc-500">No</span>}
                    </td>
                    <td className="py-3 pr-4">
                    ...
                    <td className="py-3 text-zinc-600 dark:text-zinc-400">
                      {["pnp", "study-pgwp", "iec"].includes(route.id) ? <span className="text-green-400">Yes</span> : <span className="text-zinc-600 dark:text-zinc-500">No</span>}
                    </td>
                  </tr>
                ))}
              </tbody>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="bg-zinc-50 dark:bg-zinc-950 border border-zinc-300 dark:border-zinc-800 rounded-lg p-3">
                      <p className="text-[10px] uppercase tracking-widest text-zinc-600 dark:text-zinc-500 mb-1">Leads to PR?</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <Link href="/japa-dev/visa" className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-800 hover:border-green-900 rounded-xl p-5 transition-colors group">
            <p className="text-xs uppercase tracking-widest text-zinc-600 dark:text-zinc-500 mb-2">Compare with</p>
            <p className="text-sm font-bold text-zinc-800 dark:text-zinc-200 group-hover:text-green-300 transition-colors" style={{ fontFamily: "Syne, sans-serif" }}>🇬🇧 UK Visa Guide →</p>
            <p className="text-xs text-zinc-600 dark:text-zinc-500 mt-1">Higher salary bar, stronger political long game.</p>
          </Link>
          <Link href="/japa-dev" className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-800 hover:border-zinc-400 dark:hover:border-zinc-600 rounded-xl p-5 transition-colors group">
            <p className="text-xs uppercase tracking-widest text-zinc-600 dark:text-zinc-500 mb-2">Back to</p>
            <p className="text-sm font-bold text-zinc-800 dark:text-zinc-200 group-hover:text-zinc-900 dark:hover:text-white transition-colors" style={{ fontFamily: "Syne, sans-serif" }}>Job Tracker →</p>
            <p className="text-xs text-zinc-600 dark:text-zinc-500 mt-1">Track remote and Web3 applications.</p>
          </Link>
        </div>
