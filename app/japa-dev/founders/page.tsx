...
function StagePill({ stage }: { stage: string }) {
  return (
    <span className="text-[9px] px-1.5 py-0.5 rounded bg-zinc-800 text-zinc-400 border border-zinc-700 font-mono uppercase tracking-wider">
      {stage}
    </span>
  );
}
  ...
  return (
    ...
    >
      ...
      <header className="border-b border-zinc-900 px-6 py-4 flex items-center justify-between sticky top-0 bg-[#080808]/95 backdrop-blur z-40">
        <Link
          href="/japa-dev"
          className="text-sm font-bold text-zinc-100 tracking-widest uppercase hover:text-green-400 transition-colors"
          style={{ fontFamily: "Syne, sans-serif" }}
        >
          ← JapaDev
        </Link>
        <div className="flex items-center gap-4">
          <Link href="japa-dev/visa" className="text-xs text-zinc-500 hover:text-zinc-300 transition-colors">
            UK Visa Guide
          </Link>
          <span className="text-zinc-600 text-xs">Founders · 2026</span>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mb-12">
          ...
          <h1
            className="text-3xl font-bold text-zinc-100 mb-4 leading-tight"
            style={{ fontFamily: "Syne, sans-serif" }}
          >
          ...
          {CATEGORY_ORDER.map((cat) => {
            ...
            return (
              ...
              >
                ...
                <div className="text-zinc-600 text-xs mt-1">{count} programs</div>
              </a>
            );
          })}
        </div>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5">
                      ...
                      <div className="bg-zinc-950 border border-zinc-800 rounded-lg p-3">
                        ...
                        <p
                          className={`text-xs font-bold ${
                            p.remote ? "text-green-400" : "text-zinc-400"
                          }`}
                        >
                      ...
                      <div className="bg-zinc-950 border border-zinc-800 rounded-lg p-3">
                        ...
                        <p className="text-xs text-zinc-300 leading-tight">{p.deadline}</p>
                      </div>
                    </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          ...
          >
            ...
            <p
              className="text-sm font-bold text-zinc-200 group-hover:text-white transition-colors"
              style={{ fontFamily: "Syne, sans-serif" }}
            >
              UK Visa Guide →
            </p>
